...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是 Ding, 歡迎來到我的 Blog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ding Ding', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜歡探索、持續學習的生活熱愛者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-chi-lovat.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 閱讀, 筆記, 人類圖, 理財, 預算, YNAB', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,email,facebook,messenger,line', // 分享的服務，按顺序显示,逗号隔开
